...
<table id="table_466538B1C2A646B89EB4F9AA111203BE"> 
 <thead> 
  <tr> 
   ...
   <th colname="col3" class="entry"><b>カスタマイズは、 <span class="codeph"> AdBreakPolicySelector</b></span> </th> 
  </tr>
 </thead>
 <tbody> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">詳しくは、 <a href="../../../tvsdk-3x-android-prog/android-3x-content-playback-options-android2/ui-configure/android-3x-ui-seek-scrub-bar-display.md" format="dita" scope="local"> シークスクラブバーを現在の再生位置で表示</a>. </td> 
  </tr> 
 </tbody> 
</table>
