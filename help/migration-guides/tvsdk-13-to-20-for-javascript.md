...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>interface TimedMetadata {<br /> const unsigned short METADATA_TYPE_TAG = 0 ;<br /> const unsigned short METADATA_TYPE_ID3 = 1 ;<br /> readonly attribute unsigned short metadataType;<br /> readonly attribute long time;&lt;adom/&gt; readom文字列名；<br /> <br /> readonly attribute Object metadata;<br /> };<br /><br /></p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>interface AdBreak {<br /> readonly attribute重複時間；<br /> readonly属性重複replaceDuration;<br /> <br /> readonly属性重複時間；<br /> readonly属性AdList adList;<br /> <br />読み取り専用属性DomStringデータ；<br /> <br />; </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>interface MediaPlayerConfig {<br /> <br /> <br /> <br /> attribute StringList adTags;<br /> attribute StringList subscribedTags;<br /> attribute MediaPlayerClientFactory;&lt;a6&gt; <br /> <br /> &lt;a9&gt;a10/&gt; <br /> };<br /><br /><br /></p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface DRMPolicy<br /> {<br /> readonly attribute DomString authenticationDomain;<br /> readonly attribute DRMAuthenticationMethod authenticationMethod;<br /> <br /> readonly attribute DomString displayName;<br /> readonly attribute attribute liceadonly attribute licensedomain;<br /> };</p> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>interface MediaPlayer :EventTarget<br /> {<br /> void prepareToPlay(重複位置);<br /> void play();<br /> void pause();<br /> void seek(重複位置);<br /> voidseekToLocal(重複位置);<br /> void();<br /> void);<br /> void replaceCurrentItem(MediaPlayerItem item);<br /> void replaceCurrentResource(MediaResource, <br /> MediaPlayerItemConfig);<br /> void suspend();<br /> void restore();<br /> void notifyClick();<br /> <br /> readonly attribute TimeRange playbackRange;<br /> readonly attribute TimeRange seekableRange;<br /> readonly属性重複currentTime;<br /> readonly属性重複localTime;<br /> readonly属性TimeRange bufferedRange;<br /> readonly属性DRMManager drmManager;<br />読み取り専用属性MediaPlayerItem;<br /> <br /> // Player Status<br /> <br /> <br /> const unsigned short PLAYER_STATUS_INITIALIZED;<br /> const unsigned short PLAYER_STATUS_PREPARED;<br /> const unsigned short PLAYER_STATUS_PLAYING;<br /> const unsigned short PLAYER_STATUS_PAUSED;<br /> const unsigned short PLAYER_STATUS_SEEKING;<br /> const unsigned short PLAYER_STATUS_COMPLETE;<br /> const unsigned short PLAYER_STATUS_ERROR;<br /> <br />const unsigned short PLAYER_STATUS_RELEASED;<br /> <br /> readonly attribute unsigned short status;<br /> <br /> attribute unsigned short volume;<br /> attribute ABRControlParameters abrControlParameters;&lt;a6&gt;7/&gt; const unsigned short VISIBLE;//CCの表示/非表示<br />const unsigned short INVISIBLE;//CCの表示/非表示<br />属性unsigned short ccVisibility;<br />属性TextFormat ccStyle;<br />読み取り専用属性PlaybackMetrics playbackMetrics;<br /> <br />属性重複率；<br />属性MediaPlayerView表示;<br /> readonly attribute Timeline;<br /> attribute重複currentTimeUpdateInterval;<br /> // setting this Won't be supported for 2.0<br /> };<br /><br /><br /></p> </td> 
   <td><p>interface MediaPlayer :EventTarget<br /> {<br /> void prepareToPlay( int position);<br /> void play();<br /> void pause();<br /> void seek( int position);<br /> voidToLocalTime( int position);<br /> void();<br /> void);<br /> void replaceCurrentItem(MediaResource source);<br /> <br /> <br /> <br /> <br /> <br /> readonly attribute TimeRange playbackRange;<br />attribute TimeRange seekableRange;<br /> readonly attribute重複currentTime;<br /> readonly属性重複localTime;<br /> readonly属性TimeBufferedRange;<br /><br /> readonly属性DRMManager drmManager;<br /> readonly属性MediaPlayerItem currentItem;<br /> <br /> // PlayerState<br /> const unsigned short PLAYER_STATE_IDLE;&lt;a4/ const unsed shortPLAYER_STATE_INITIALIZED;<br /> const unsigned short PLAYER_STATE_PREPARING;<br /> const unsigned short PLAYER_STATE_PREPARED;<br /> const unsigned short PLAYER_STATE_PAUSED;<br />const unsigned short PLAYER_STATE_SEEKING;<br /> const unsigned short PLAYER_STATE_COMPLETE;<br /> const unsigned short PLAYER_STATE_ERROR;<br /> const unsigned short PLAYER_RELEALEASEDstatus_SUSPENDED;<br /> <br /><br /><br /><br />readonly属性unsigned short状態；<br /> <br />属性unsigned shortボリューム；<br />属性ABRControlParameters abrControlParameters;<br />属性BufferControlParameters;<br /> <br />読み取り専用の未署名の短いVISIBLE;//CCの表示<br />は読み取り専用で、符号なしの短いINVISIBLE;//CCの表示/非表示<br />属性unsigned short ccVisibility;<br />属性TextFormat ccStyle;<br />読み取り専用属性PlaybackMetrics;<br />属性MediaPlayerConfig mediaPlayerConfig;<br />属性重複率；<br /> attribute MediaPlayerView表示;<br /> readonly attribute Timeline;<br /> <br /> <br /> };</p> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>2.0では変更はありません。</td> 
   <td><p>interface TextFormat<br /> {<br /> // Color<br /> const unsigned short COLOR_DEFAULT = 0 ;<br /> const unsigned short COLOR_BLACK = 1 ;<br /> const unsigned short COLOR_GRAY = 2 ;&lt;a5/ unsigned&gt;short COLOR_BRIGHT_WHITE = 4 ;<br /> const unsigned short COLOR_DARK_RED = 5 ;<br /> const unsigned short COLOR_RED = 6 ;<br /> const unsigned short COLOR_BRIGHT = 7 ;<br /> const unsigned short COLOR_DARK_GREEN8 ;<br /> const unsigned short COLOR_GREEN = 9 ;<br /> const unsigned short COLOR_BRIGHT_GREEN = 10 ;<br /> const unsigned short COLOR_DARK_BLUE = 11 ;<br /> const unsigned short COLOR_BLUE_BLUE = ; 12<br /> const unsigned short COLOR_BRIGHT_BLUE = 13 ;<br /> const unsigned short COLOR_DARK_YELLOW = 14 ;<br /> const unsigned short COLOR_YELLOW = 15 ;<br /><br /><br /> const unsigned short COLOR_BRIGHT_YELLOW = 16 ;<br /> const unsigned short COLOR_DARK_MAGENTA = 17 ;<br /> const unsigned short COLOR_BRIGHT_MEZENTA = 18 ;<br /> const unsigned short short color_COLORdark_CYAN = 20 ;<br /> const unsigned short COLOR_CYAN = 21 ;<br /> const unsigned short COLOR_BRIGHT_CYAN = 22 ;<br /> readonly attribute unsigned short fontColor;<br /> readonly attribute unsigned shortfillColor;<br /> readonly attribute unsigned short edgeColor;<br /> <br /> // Size<br /> const unsigned short SIZE_DEFAULT = 0 ;<br /> const unsigned short SIZE_SMALL = 1 ;<br /> unsigned short SIZEMEDIUM = 2 ;<br /> <br /><br /><br />const unsigned short SIZE_LARGE = 3 ;<br /> <br /> readonly attribute unsigned short size;<br /> <br /> // FontEdge<br /> const unsigned short FONT_EDGE_DEFAULT = 0 ;<br /> const unsigned shortfont_EDGE_RAISED = 2 ;<br /> const unsigned short FONT_EDGE_DEPRESS = 3 ;<br /> const unsigned short FONT_EDGE_UNIFORM = 4 ;<br /> const unsigned short FONT_EDGE_DROP_LEFT_LEFT = 5 ;<br /> unsigned fort_EDGE_DROP_SHADOW_RIGHT = 6 ;<br /> readonly attribute unsigned short fontEdge;<br /> <br /> // Font<br /> const unsigned short FONT_DEFAULT = 0 ;<br /> const unsigned short short FONT_ FONT_ FONT_SPACED_FONT_ FONT_SPACEDwith_SERIFS = 1 ;<br /> <br />const unsigned short FONT_PROPORTIONAL_WITH_SERIFS = 2 ;<br /> const unsigned short FONT_MONSPACED_WITHOUT_SERIFS = 3 ;<br /> const unsigned short FONT_CUSIVE = 4 ;<br /> cont unsigned short FONT_ FONTsmall_CAPITALS = 6 ;<br /> readonly attribute unsigned short font;<br /> readonly attribute unsigned short fontOpacity;<br /> readonly attribute unsigned short fillOpacity;<br /> readonly attribute unsigned short DEFAULT_OPACITY;&lt;A9/ };<br /><br /><br /></p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>interface MediaPlayerItem {<br /> readonly attribute MediaResource resource;<br /> readonly attribute long resourceId;<br /> readonly attribute boolean live;<br /> <br /> readonly attribute boolean hasAlternateAudio;<br /> readonly attribute AudioTrackList aud Auifon属性audioTrack selectedAudioTrack;<br /> <br /> <br /> readonly属性boolean hasClosedCaptions;<br /> readonly属性ClosedCaptionsTrackList ccTracks;<br /> attribute ClosedCaptionsTrack;<br /><br /> <br /> <br /> readonly attribute boolean hasTimedMetadata;<br /> readonly attribute TimedList timedMetadata;<br /> readonly attribute boolean dynamic;<br /> <br /> readonly boolean isProtected;a20/&gt; readonly attribute DRMMetadataInfoList drmMetadataInfos;<br /> readonly attribute ProfileListプロファイル;<br /> <br /> <br /> readonly attribute boolean trickPlaySupported;<br /> readonly attribute32Array availablePlaybackRates;<br /> <br /> readonly attribute StringList adTags;<br /> <br /> readonly attribute MediaPlayer;<br /> <br /> };<br /><br /></p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>2.0では変更はありません。</td> 
   <td><p>interface LoadInfo<br /> {<br /> readonly attribute DomString url;<br /> readonly attribute int size;<br /> readonly attribute int periodIndex;<br /> readonly attribute mediaDuration;<br /> readonly attribute short TRACK_TYPE_TYPE_ READONLYFRAGMENT;&lt;A7/&gt; READONLY ATTRIBUTE SHORT TRACK_TYPE_TRACK;<br /> readonly attribute short TRACK_TYPE_MANIFEST;<br /> readonly attribute short type;<br /> readonly attribute DomStringType;12/&gt; readonly attribute int trackIndex;<br /> };<br /><br /><br /><br /></p> </td> 
  </tr> 
 </tbody> 
</table>
