...
PrimetimeAd Insertion20.12.1のリリースノートでは、2020年のPrimetimeAd Insertionの新しい問題や変更された問題、解決された問題、既知の問題について説明します。

## PTAI 20.12.1の新機能

**日時：2020年12月8日** 火曜日午前01:00 ～午前04:00東部時間

**変更点**

* 2020年11月30日に発生したPrimetimeAd Insertionでの断続的なクライアント接続(5xx)の問題に対処するための修正プログラムが含まれます。
