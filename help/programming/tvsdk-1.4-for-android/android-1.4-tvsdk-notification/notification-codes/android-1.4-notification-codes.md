...
<table frame="all" colsep="1" rowsep="1" id="table_DBA8CACF02DB4AF2B053E560850B49CE"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">通知タイプ。 プラットフォームに応じて、このプロパティは列挙型を参照し、<span class="codeph"> INFO</span>、<span class="codeph"> WARN</span>、<span class="codeph"> ERROR</span>の値を取り得ます。 これは、通知のトップレベルのグループです。 </td> 
  </tr> 
  <tr rowsep="1"> 
