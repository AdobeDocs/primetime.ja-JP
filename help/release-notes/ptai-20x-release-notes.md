---
title: PTAI 20.8.1リリースノート
description: PTAI 20.8.1のリリースノートでは、2020年のPrimetime DynamicAd Insertionの新しい問題や変更された問題、解決された問題、既知の問題について説明します。
...
# Primetime動的Ad Insertion20.8.1リリースノート

動的Ad Insertion20.8.1のリリースノートでは、2020年のPrimetime DynamicAd Insertionの新機能や変更点、解決された問題、既知の問題について説明します。
