...
<table frame="all" colsep="1" rowsep="1" id="table_389797D3CEF14EA2862E0B20C6E6CC41"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/logging/Log.html" format="html" scope="external"> ログ</a> </span></td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2" rowsep="0"> クラス。 エントリログを定義し、ログメッセージに関する情報を保持します。 </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> インターフェイス。 カスタムログを有効にします。 </td> 
  </tr> 
  <tr rowsep="1"> 
