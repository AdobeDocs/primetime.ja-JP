---
title: PTAI 20.10.1リリースノート
description: PTAI 20.10.1リリースノートでは、2020年のPrimetimeAd Insertionの新しい問題や変更された問題、解決された問題、既知の問題について説明します。
...
# PrimetimeAd Insertion20.10.1リリースノート

PrimetimeAd Insertion20.10.1のリリースノートでは、2020年のPrimetimeAd Insertionの新しい問題や変更された問題、解決された問題、既知の問題について説明します。
...
**2020年9月30日** 水曜日午前3時30分～午前6時30分東部時間

**変更点**

* BootstrapAPIパラメータ`ptparallelstream`を追加しました。 これにより、CMAFのデミュックスオーディオまたはビデオストリームをリクエストするプレーヤーを持つお客様は、オーディオとビデオトラックの広告の一貫性を確保できます。 この機能を有効にするにはパラメータ値をtrueに設定し、無効にするには省略します。

#### バージョン20.9.2

**日時：2020年9月15** 日火曜日午前3時半から午前6時30分まで東部標準時

**機能強化**

* `EXT-X-MARKER`タグを使用して、非線形広告タイプを含めることができます。
...
**日時：2020年9月1日** 火曜日午前3時半から午前7時30分まで東部標準時
...
**2020年8月19日** 水曜日、03:30 AMから07:30 AM東部時間
...
**日時：2020年8月4日** 火曜日午前3時から午前6時（東部標準時）
...
**日時：2020年7月9日** 木曜日午前03:00 ～午前5:00東部時間
...
**日時：2020年6月18** 日木曜日午前03:00から午前04:00まで東部標準時

**機能強化**

ミリ秒の精度が必要なビデオクライアントのストリーム同期を改善。 `#EXT-X-PROGRAM-DATE-TIME tags`のミリ秒の精度を有効にするには、Adobeサポートにお問い合わせください。

#### バージョン20.6.1

**日時：2020年6月2日** 火曜日午前03:00 ～午前5:00東部時間
...
**日時：2020年5月5** 日火曜日午前04:00 ～午前5:00東部時間
...
**2020年4月1日** 水曜日の日時：03:00 AM ～ 04:00 AM東部時間
...
**日時：2020年3月26** 日木曜日午前03:00 ～午前04:00東部時間
...
**2020年3月11日** 水曜日、05:30 AMから07:00 AM東部標準時
...
**日時：2020年3月5** 日木曜日02:30 AMから04:30 AM東部時間
...
**日時：2020年2月13** 日木曜日午前04:30 ～午前05:30東部時間
...
**日時：2020年1月28** 日火曜日午前2時から午前03時（東部標準時）

* **FERでnbc CueFormatをサポートするVMAP**

   `ptcueformat=nbc`が使用され、ストリームがマニフェスト内キューとベイクイン広告を含むVODストリームである場合、FERストリームのキューをFWタイムラインオーバーライドパラメーターに変換します。
...
**日時：2020年1月20日** 月曜日午前02:00 ～午前03:00（東部標準時）

* メンテナンスの更新。

#### バージョン20.1.1

**2020年1月15** 日（水）の日時：04:00 AMから05:00 AM東部時間
