---
title: PTAI 20.7.1リリースノート
description: PTAI 20.7.1のリリースノートでは、2020年のPrimetime Dynamic Ad Insertionで解決され、既知の問題である、新機能や変更点について説明します。
...
# Primetime Dynamic Ad Insertion 20.7.1リリースノート

Dynamic Ad Insertion 20.7.1のリリースノートでは、2020年のPrimetime Dynamic Ad Insertionの新機能や変更点、解決された問題、既知の問題について説明します。
...
* セッション統計パネルのSSAIコンソールダッシュボードが強化されました。
...
ミリ秒の精度が必要なビデオクライアントのストリーム同期を改善。 のミリ秒精度を有効にする場合は、アドビサポートにお問い合わせく `#EXT-X-PROGRAM-DATE-TIME tags`ださい。
...
* `EXT-X-DISCONTINUITY` 広告からコンテンツに切り替えると、タグがプレイリストの上部から削除されます。 この修正を有効にするには、アドビサポートにお問い合わせください。
