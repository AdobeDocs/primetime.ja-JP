...
seo-description: TVSDKは、複数の初期PlacementInformationを設定できます。
seo-title: 複数の初期PlacementInformation
...
# 複数の初期PlacementInformation{#multiple-initial-placementinformations}
