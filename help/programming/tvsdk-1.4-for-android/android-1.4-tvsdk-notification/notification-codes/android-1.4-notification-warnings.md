...
<table frame="all" colsep="1" rowsep="1" id="table_C24772DF203B4DB2ACE6B475698C4C58"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="5"> DRM マイナーエラーコードと DRM サーバーエラー文字列。 詳しくは、 <a href="../../../tvsdk-1.4-for-android/android-1.4-tvsdk-notification/notification-codes/native-error-summary/android-1.4-native-error-summary.md" format="html" scope="external"> NATIVE_ERROR 通知の詳細</a> を参照してください。</td> 
  </tr> 
  <tr rowsep="1"> 
...
>[注意！] adID とソース (URL) は、PTAdAsset を通じて、 `AD_ASSET` キー。
